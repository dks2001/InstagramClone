...
public class SharePictureTab extends Fragment implements  View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        edtDescriptoion = view.findViewById(R.id.edtdescription);
        imageView = view.findViewById(R.id.addImageView);
        shareButton = view.findViewById(R.id.shareButton);

        imageView.setOnClickListener(SharePictureTab.this);
        shareButton.setOnClickListener(SharePictureTab.this);
        ...
        switch (view.getId()) {
            ...
            case R.id.shareButton:
                ...
                if(receivedImageBitmap != null) {
                    if(edtDescriptoion.getText().toString().equals("")) {
                        ...
                        parseObject.put("image_des",edtDescriptoion.getText().toString());
